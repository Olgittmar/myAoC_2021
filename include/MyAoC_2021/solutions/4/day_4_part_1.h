#ifndef MYAOC_2021_SOLUTIONS_4_DAY_4_4_PART_1_H
#define MYAOC_2021_SOLUTIONS_4_DAY_4_4_PART_1_H
...
class BingoBoard {
  public:
    ...
    [[nodiscard]] auto HaveWon() const -> bool;
    void MarkIfOnBoard(int key);
    [[nodiscard]] auto Score(int justCalled) const -> int;
